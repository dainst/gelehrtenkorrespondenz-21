# NOTE: This file is a copy from the cilantro project:
#   https://github.com/dainst/cilantro/blob/master/workers/nlp/formats/book_viewer_json.py
# We might in the future decide to put this and other format conversion utilitises
# in a separate library, but as it is currently only used in two places, that seemed overkill.
